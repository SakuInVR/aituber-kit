...
export const ChatLog = () => {
  ...
  // 最新メッセージがAI自動発話かどうか判定
  const latestMessage = messages.length > 0 ? messages[messages.length - 1] : null;
  const isAutoChatSpeaking =
    latestMessage && latestMessage.isAutoGenerated && latestMessage.role === 'assistant';
    ...
    >
      ...
      {isAutoChatSpeaking && (
        <div className="mt-2 flex justify-center">
          <span className="inline-block bg-blue-100 text-blue-700 px-4 py-1 rounded-full text-sm font-semibold animate-pulse">
            AI発話中...
          </span>
        </div>
      )}
